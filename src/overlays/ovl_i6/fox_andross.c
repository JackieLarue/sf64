    ...
    switch (this->state) {
        ...
        case 20:
            ...
            if (gCsFrameCount == 200) {
                ...
                Effect_BossExplosion_Spawn(this->obj.pos.x, this->obj.pos.y, this->obj.pos.z, 40.0f);
...
void Andross_LevelComplete(Player* player) {
    ...
    switch (player->csState) {
        ...
        case 1: // Andross Robot exploding, Arwing does a U-turn
            ...
            switch (gCsFrameCount) {
                case 80:
                    Effect_BossExplosion_Spawn(boss->obj.pos.x, boss->obj.pos.y, boss->obj.pos.z, 40.0f);
